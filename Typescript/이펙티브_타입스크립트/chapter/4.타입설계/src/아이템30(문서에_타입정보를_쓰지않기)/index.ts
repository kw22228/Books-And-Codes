...
// 불필요하게 장황하다. 함수선언보다 주석이 더길어버린다.

/** 불필요한 주석을 빼고, 타입으로 설명하는 경우 */
interface Color {
    r: number;
    g: number;
    b: number;
...
function getForegroundColorWithType(page?: string): Color {
    return page === 'login' ? { r: 127, g: 127, b: 127 } : { r: 0, g: 0, b: 0 };
}
...
function sortWithType(nums: readonly number[]) {} //readonly구문으로 변경하지 못함.
